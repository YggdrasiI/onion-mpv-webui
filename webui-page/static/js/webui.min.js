 ...
 * @license MIT
 */window.addEventListener("click",observeEventsForTouchmenu,{capture:!0}),window.addEventListener("mouseup",observeEventsForTouchmenu,{capture:!0}),window.addEventListener("pointerup",observeEventsForTouchmenu,{capture:!0}),window.addEventListener("touchend",observeEventsForTouchmenu,{capture:!0}),window.addEventListener("click",hideTouchMenu,{capture:!1}),screen.orientation.addEventListener("change",(e=>{touchmenu._update_innerHeight=!0})),function(e,t){"use strict";"function"!=typeof e.CustomEvent&&(e.CustomEvent=function(e,n){n=n||{bubbles:!1,cancelable:!1,detail:void 0};var s=t.createEvent("CustomEvent");return s.initCustomEvent(e,n.bubbles,n.cancelable,n.detail),s},e.CustomEvent.prototype=e.Event.prototype),t.addEventListener("touchstart",(function(t){if(n&&console.log("Touch start"),n&&console.log(t.timeStamp),n&&console.log(`Touch start x + ${t.changedTouches.length} = ${t.touches.length}`),t.changedTouches.length<t.touches.length)return t.timeStamp-r.timestampStart1>=100?void(n&&console.log("Delayed second touch ignored")):void(r.timestampStart2=t.timeStamp);if("true"===d(t.target,"data-swipe-ignore","false"))return void(r.timestampStart1=-1);const s=t.touches[0];(r={idFinger1:s.identifier,timestampStart1:t.timeStamp,timestampStart2:t.changedTouches.length>1?t.timeStamp:null,xDown:s.screenX,yDown:s.screenY,targetStart:t.target}).scrollPositionsDown=[],l(r.scrollPositionsDown,t.target,t.currentTarget||e)}),!1),t.addEventListener("touchend",(function(u){n&&console.log(`Touch ${u.changedTouches[0].identifier==r.idFinger1?1:2} end ${u.changedTouches.length}`),n&&console.log(u.timeStamp),n&&console.log("TDiff: "+(u.timeStamp-r.timestampStart1));let c=!1;for(let t=0;t<u.changedTouches.length;++t)if(u.changedTouches[t].identifier===r.idFinger1){const n=u.changedTouches[t];r.xUp=n.screenX,r.yUp=n.screenY,r.timestampEnd1=u.timeStamp,r.touchType=n.touchType||"direct",r.scrollPositionsUp=[],l(r.scrollPositionsUp,u.target,u.currentTarget||e),c=!0;break}if(!1===c&&1===u.touches.length&&(r.timestampEnd2=u.timeStamp),0===u.touches.length){if(u.changedTouches.length>1&&(r.timestampEnd2=u.timeStamp),u.timeStamp-r.timestampEnd1>=100)return void(n&&console.log("First finger released too early. Ignore gesture"));!function(e){const n=r.targetStart;if(r.targetStart!==e.target)return;if(console.log(e),function(e,t){if(e.length!==t.length)return!0;for(let n=0;n<e.length;++n){const a=Math.abs(e[n][0]-t[n][0]),i=Math.abs(e[n][1]-t[n][1]);if(a>s||i>s)return!0}return!1}(r.scrollPositionsDown,r.scrollPositionsUp))return void console.log("Scrolled!!!!");var l=parseInt(d(n,"data-swipe-threshold","20"),10),u=d(n,"data-swipe-unit","px"),c=parseInt(d(n,"data-swipe-timeout","500"),10);"vh"===u&&(l=Math.round(l/100*t.documentElement.clientHeight)),"vw"===u&&(l=Math.round(l/100*t.documentElement.clientWidth));var p=function(e,t,n,s,a){if(Math.abs(e)<=s&&Math.abs(t)<=s)return null;if(n>=a)return null;const i=Math.atan2(t,e)*(4/Math.PI),r=Math.floor(i+.5+4);return o[r]}(r.xDown-r.xUp,r.yDown-r.yUp,r.timestampEnd1-r.timestampStart1,l,c);if(null!==p){var m={dir:p.replace(/swiped-/,""),touchType:r.touchType,xStart:parseInt(r.xDown,10),xEnd:parseInt(r.xUp,10),yStart:parseInt(r.yDown,10),yEnd:parseInt(r.yUp,10),fingers:r.timestampEnd2?2:1};i&&n.dispatchEvent(new CustomEvent("swiped",{bubbles:!0,cancelable:!0,detail:m})),a&&n.dispatchEvent(new CustomEvent(p,{bubbles:!0,cancelable:!0,detail:m}))}r={}}(u)}}),!1);const n=!1,s=50,a=!1,i=!0,o=["swiped-right",null,"swiped-down",null,"swiped-left",null,"swiped-up",null,"swiped-right"];var r=null;function l(e,t,n){let s=t;for(;s&&(e.push([s.scrollTop,s.scrollLeft]),(s=s.parentElement)!==n););}function d(e,n,s){for(;e&&e!==t.documentElement;){var a=e.getAttribute(n);if(a)return a;e=e.parentNode}return s}}(window,document);