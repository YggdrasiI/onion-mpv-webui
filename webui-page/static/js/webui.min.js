 ...
 * @license MIT
 */!function(e,t){"use strict";"function"!=typeof e.CustomEvent&&(e.CustomEvent=function(e,n){n=n||{bubbles:!1,cancelable:!1,detail:void 0};var s=t.createEvent("CustomEvent");return s.initCustomEvent(e,n.bubbles,n.cancelable,n.detail),s},e.CustomEvent.prototype=e.Event.prototype),t.addEventListener("touchstart",(function(e){"true"!==e.target.getAttribute("data-swipe-ignore")&&(u=e.target,d=Date.now(),i=e.touches[0].clientX,o=e.touches[0].clientY,r=0,l=0,c=e.touches.length)}),!1),t.addEventListener("touchmove",(function(e){if(i&&o){var t=e.touches[0].clientX,n=e.touches[0].clientY;r=i-t,l=o-n}}),!1),t.addEventListener("touchend",(function(e){if(null!==i&&u===e.target){var m=parseInt(p(u,"data-swipe-threshold","20"),10),h=p(u,"data-swipe-unit","px"),_=parseInt(p(u,"data-swipe-timeout","500"),10),f=e.changedTouches||e.touches||[];"vh"===h&&(m=Math.round(m/100*t.documentElement.clientHeight)),"vw"===h&&(m=Math.round(m/100*t.documentElement.clientWidth));var g=function(e,t,n,s){if(Math.abs(e)<=n&&Math.abs(t)<=n)return null;if(Date.now()-d>=s)return null;const i=Math.atan2(t,e)*(4/Math.PI),o=Math.floor(i+.5+4);return a[o]}(r,l,m,_);if(null!==g){var y={dir:g.replace(/swiped-/,""),touchType:(f[0]||{}).touchType||"direct",fingers:c,xStart:parseInt(i,10),xEnd:parseInt((f[0]||{}).clientX||-1,10),yStart:parseInt(o,10),yEnd:parseInt((f[0]||{}).clientY||-1,10)};s&&u.dispatchEvent(new CustomEvent("swiped",{bubbles:!0,cancelable:!0,detail:y})),n&&u.dispatchEvent(new CustomEvent(g,{bubbles:!0,cancelable:!0,detail:y}))}i=null,o=null,d=null}}),!1),t.addEventListener("scroll",(function(e){null!==i&&(console.log("Abort"),i=null,o=null,d=null)}),!1);const n=!1,s=!0,a=["swiped-right",null,"swiped-down",null,"swiped-left",null,"swiped-up",null,"swiped-right"];var i=null,o=null,r=null,l=null,d=null,u=null,c=0;function p(e,n,s){for(;e&&e!==t.documentElement;){var a=e.getAttribute(n);if(a)return a;e=e.parentNode}return s}}(window,document);